...
export function createReceivedDataEvent(requestAddress: Address): ReceivedData {
  let receivedDataEvent = changetype<ReceivedData>(newMockEvent())

  receivedDataEvent.parameters = new Array()

  receivedDataEvent.parameters.push(
    new ethereum.EventParam(
      "requestAddress",
